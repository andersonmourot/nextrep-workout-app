...
struct ProgramHistoryDetailView: View {
    ...
    private func workoutLogCard(log: WorkoutLog) -> some View {
        ...
        return VStack(alignment: .leading, spacing: 12) {
            // Day name + date
            dayNameDateSection(day: day, log: log)
            
            // Exercise logs with weights × reps
            exerciseLogsSection(log: log)
        }
        .padding(12)
        .background(Theme.surface)
        .cornerRadius(12)
    ...
    private func dayNameDateSection(day: ProgramDay?, log: WorkoutLog) -> some View {
        HStack {
    ...
    private func exerciseLogsSection(log: WorkoutLog) -> some View {
        VStack(spacing: 8) {
    ...
    private func exerciseLogCard(exerciseLog: ExerciseLog) -> some View {
